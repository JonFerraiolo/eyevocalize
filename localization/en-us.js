...
`,
	...
	builtinFavoritesCollections: [
		...
		{ label: 'Eye gaze', default: true, column: 3, category: 'Eye gaze', items: [
			{ type: 'text', label: 'gaze probs', text: "please help with eye gaze"},
			{ type: 'text', label: 'bright', text: "the light is too bright, making it difficult to use eye gaze"},
			{ type: 'text', label: 'yesno', text: "I am having trouble with my eye gaze at the moment, so I may not be able to answer questions. Maybe try asking me questions that have yes and no answers. "},
		]},
		{ label: 'Opposites', default: true, column: 2, category: 'Opposites', items: [
			...
			{ type: 'text', label: 'more', text: 'more please'},
			{ type: 'text', label: 'less', text: 'less please'},
		]},
		...
		{ label: 'ALS Requests', default: true, column: 2, category: 'Care Requests', items: [
			...
			{ type: 'text', label: 'nebul', text: 'Time for nebulizer and feeding'},
			{ type: 'text', label: 'cough', text: 'Cough assist machine please'},
			...
			{ type: 'text', label: 'hurts', text: 'Something hurts.'},
		...
		{ label: 'ALS Adjustments', default: true, column: 2, category: 'Care Adjustments', items: [
			...
			{ type: 'text', label: 'feet', text: 'Please move my feet. They are uncomfortable.'},
