...
const Localization = {
  help: {
    ...
    FeaturesContent: `
      ...
      <ul>
        <li>Type text, then press Return (or click the speak icon) to cause the typed words to be spoken using voice synthesis</li>
        <li>A built-in library of common expressions, such as yes, no, please, thank you, hello, goodbye, etc.</li>
        <li>Ability to define your own favorites for phrases that you use repeatedly </li>
        <li>Ability to prepare text in advance and store on the Clipboard for one-click speaking at just the right time </li>
        <li>EyeVocalize saves your history of vocalizations so you can search for things you said in the past and repeat again </li>
        <li>For fun, you can play Web audio clips or YouTube clips, such as "Houston, we have a problem" </li>
        <li>If you sign up and login, which are recommended, EyeVocalize By default will back up your history, clipboard, favorites and some other settings to the EyeVocalize server. If you have multiple eye gaze systems like me, and you allow EyeVocalize to back up your data, EyeVocalize will sync your data across all of your systems and browsers.  </li>
      </ul>
    `,
    Shortcuts: `Shortcuts`,
  },
